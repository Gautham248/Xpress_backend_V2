...
namespace Xpress_backend_V2.Migrations
{
    ...
    [Migration("20250702061456_AddedAccommodationInsuranceDocPaths")]
    partial class AddedAccommodationInsuranceDocPaths
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Xpress_backend_V2.Models.TravelRequest", b =>
                {
                    ...
                    b.Property<List<string>>("AccommodationDocumentPath")
                        .HasColumnType("jsonb");

                    b.Property<int?>("AssignedWorkflowId")
                        .HasColumnType("integer");
                    ...
                    b.PrimitiveCollection<List<string>>("TicketDocumentPath")
                        .HasColumnType("text[]");
            ...
            modelBuilder.Entity("Xpress_backend_V2.Models.WorkflowHistory", b =>
                {
                    ...
                    b.Property<int>("NewWorkflowId")
                        .HasColumnType("integer");

                    b.Property<int?>("OldWorkflowId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("NewWorkflowId");

                    b.HasIndex("OldWorkflowId");
            ...
            modelBuilder.Entity("Xpress_backend_V2.Models.WorkflowRule", b =>
                {
                    ...
                    b.HasIndex("Priority", "UserRole", "ProjectCode");

                    b.ToTable("WorkflowRules");
                });

            modelBuilder.Entity("Xpress_backend_V2.Models.WorkflowStep", b =>
                {
            ...
            modelBuilder.Entity("Xpress_backend_V2.Models.WorkflowTemplate", b =>
                {
                    b.Property<int>("WorkflowId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Xpress_backend_V2.Models.TravelRequest", b =>
                {
                    b.HasOne("Xpress_backend_V2.Models.WorkflowTemplate", "WorkflowTemplate")
                        .WithMany("TravelRequests")
                        .HasForeignKey("AssignedWorkflowId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("Xpress_backend_V2.Models.WorkflowHistory", b =>
                {
                    b.HasOne("Xpress_backend_V2.Models.User", "ChangedByUser")
                        .WithMany("WorkflowHistories")
                        .HasForeignKey("ChangedBy")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Xpress_backend_V2.Models.WorkflowTemplate", "NewWorkflow")
                        .WithMany("WorkflowHistoriesAsNew")
                        .HasForeignKey("NewWorkflowId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Xpress_backend_V2.Models.WorkflowTemplate", "OldWorkflow")
                        .WithMany("WorkflowHistoriesAsOld")
                        .HasForeignKey("OldWorkflowId")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.Navigation("NewWorkflow");

                    b.Navigation("OldWorkflow");
            ...
            modelBuilder.Entity("Xpress_backend_V2.Models.WorkflowRule", b =>
                {
                    b.HasOne("Xpress_backend_V2.Models.RMT", "RMT")
            ...
            modelBuilder.Entity("Xpress_backend_V2.Models.WorkflowStep", b =>
                {
                    b.HasOne("Xpress_backend_V2.Models.RequestStatus", "RequestStatus")
            ...
            modelBuilder.Entity("Xpress_backend_V2.Models.WorkflowTemplate", b =>
                {
                    ...
                    b.Navigation("WorkflowHistoriesAsNew");

                    b.Navigation("WorkflowHistoriesAsOld");
